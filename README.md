...
Darkum Design is a female-owned custom furniture and home décor studio based in Heliopolis, Cairo, creating pieces made to order and delivered across Egypt. Our signature offering is a fully customizable bed frame with an interchangeable insert system, letting customers change materials, colors, and textures to reinvent its look whenever their style or mood changes.

We don't just build furniture; every piece is designed around the customer, from initial concept to final details — so instead of choosing from a standard collection, they create something that feels genuinely their own.

🛏️ Signature offering: custom bed frames with interchangeable inserts
🎨 Reinvent your piece's look anytime — swap materials, colors, and textures
...
This repository currently holds a **static "coming soon" placeholder page** while the final tech stack and site requirements are being finalized between the developer and stakeholders.

- Live placeholder: `index.html` (plain HTML/CSS/JS, no build step required)
- Production domain: `darkumdesign.com` (pending DNS configuration)
...
├── js/
│   └── script.js        # Minimal interactivity (language toggle, form handling)
...
Planned deployment target: **Vercel**, connected to the `darkumdesign.com` domain.
