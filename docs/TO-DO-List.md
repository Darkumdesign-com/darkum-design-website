...
- [ ] Sign up and configure Metricool (free plan) as the unified social inbox (Facebook, Instagram, X, LinkedIn, Google Business Profile, YouTube). Not blocked by Dema, Commercial Registration, or WooCommerce, connects to accounts Sobhy already administers solo. TikTok comment management stays manual regardless, requires a TikTok business account, which is still blocked
