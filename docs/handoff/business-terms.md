# Proposal / Business Terms, Archived, superseded by flat-rate offer
...
**Update (2026-09-13):** The full EGP 15,000 has been paid, see `business-context.md`'s Payment status entry for the details.
...
- **Plugin costs** (e.g. Advanced Product Fields, free version installed 2026-08-17 for GoDaddy compatibility testing only, paid Lifetime purchase still pending, see `bed-frame-configurator.md`) remain excluded from Sobhy's fee. As of 2026-08-16, Bido authorized Sobhy to pay for these directly rather than requiring Bido/partners to purchase from the vendor themselves (see `bed-frame-configurator.md`).
